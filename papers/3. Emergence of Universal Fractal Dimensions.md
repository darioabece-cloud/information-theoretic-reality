...
This emerges from optimizing the functional:
...
Consider a d-dimensional system where information must be both stored and accessed. We define a cost functional:
```
...
From the fractal dimension, we derive scaling relationships:
